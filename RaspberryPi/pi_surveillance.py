...
nrf = NRF24(pi, ce=27, payload_size=8, channel=100, data_rate=RF24_DATA_RATE.RATE_250KBPS, pa_level=RF24_PA.MAX)
...
timeDiff = datetime.timedelta(seconds=conf["min_upload_seconds"])
print(lastUploaded)
lastUploaded = lastUploaded - timeDiff
print(lastUploaded)
motionCounter = 0
...
for f in camera.capture_continuous(rawCapture, format="bgr", use_video_port=True):
    ...
    cv2.putText(frame, "Status: {}".format(outputText), (10, 20),
